...
var _Dot = __webpack_require__(171);

var _Slide = __webpack_require__(461);
...
var Dot = exports.Dot = function () {
  ...
  _createClass(Dot, [{
    key: "buildDot",
    value: function buildDot() {
      this.circle = d3.range(20).map(function () {
        return {
...
var Slide = exports.Slide = function Slide() {
  ...
  this.slide = d3.select("outer-container").append("svg").attr("width", 133).attr("height", 466).classed("slide", true);
};
